...
import {registerValidator, loginValidator, postCreateValidator, cardCreateValidator} from './validations/validations.js';
import {postController, userController, cardController } from './Controllers/index.js';
...
//auth app's
app.post('/auth/register', registerValidator, validationsErrors, userController.register);
app.post('/auth/login', loginValidator, validationsErrors, userController.login);
